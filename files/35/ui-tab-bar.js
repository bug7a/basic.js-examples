...
tabBar.addItem = function(iconName) {
    ...
    that.load("images/35/ui-tab-bar/" + iconName + ".svg")
...
tabBar.selectItem = function(item) {
    ...
    item.load("images/35/ui-tab-bar/" + item.iconName + "-clicked.svg")
    item.space = 6
...
tabBar.unselect = function() {
    ...
    if (tabBar.selectedItemIndex != -1) {
        ...
        tabBar.itemList[tabBar.selectedItemIndex].load("images/35/ui-tab-bar/" + tabBar.itemList[tabBar.selectedItemIndex].iconName + ".svg")
